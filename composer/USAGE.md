# Strategy Composer Usage Guide

The Strategy Composer module provides a flexible framework for combining and executing trading strategies. It follows the flow: **data → composer (reading from config, strategies) → backtester → execution**.
