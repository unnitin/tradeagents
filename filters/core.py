"""
Core filtering functionality for stock trading strategies.
...
These filters can be used across different components including backtesting, 
strategy composition, and live trading.
"""
